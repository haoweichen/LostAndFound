...
**2. How do we develop LOST&FOUND?**
	  <p>Node.JS: as our backend requirements</p>
	  <p>Express: handle our server</p>
	  <p>MongoDB: make the functionality webpages</p>
	  <p>HTML and CSS: make valid webpages</p>
	  <p>GOOGLE MAP API: position marks of lost-and-found</p>
